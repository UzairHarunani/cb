...
responses = {  
    ...
    "why do people do cyberbullying": [  
        ...
        "Sometimes, they might be replicating behavior they see in others or trying to fit in with a group."  
    ],  
}  
...
def ask():  
    ...
    return jsonify({'answer': "I'm sorry, I don't have an answer for that. Can you ask something else about cyberbullying?"})  
